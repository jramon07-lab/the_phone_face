...
let found=false;for(let i=0;i<Math.min(15,await page.locator('#waLiveChats .waChatRow').count());i++){await page.locator('#waLiveChats .waChatRow').nth(i).click();await page.waitForTimeout(600);if(await page.locator('#waSideNewOffer').isVisible()){found=true;break;}}expect(found).toBeTruthy();
