...
function fixture(){
 ...
 vm.createContext(context);vm.runInContext(source.replace("M.register('contact-google-inline',{install});","window.testApi={contactChat,makeVerification,savedVerification,writeCrm,renderVerifiedCard};"),context);
