...
const fs=require('fs'),path=require('path'),core=fs.readFileSync(path.join(__dirname,'../js/core/20-main.js'),'utf8'),inline=fs.readFileSync(path.join(__dirname,'../js/modules/contact-google-inline.js'),'utf8'),sales=fs.readFileSync(path.join(__dirname,'../js/modules/contacts-sales-core.js'),'utf8');
