...
assert.ok(runtime.includes("file==='dashboard-performance-guard.js'?'20260919-home-reference-3'"));
assert.ok(html.includes('runtime.js?v=20260919-home-reference-3'));
