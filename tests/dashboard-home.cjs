...
assert.ok(runtime.includes("file==='dashboard-performance-guard.js'?'20260919-home-reference-4'"));
assert.ok(html.includes('runtime.js?v=20260919-home-reference-4'));
