...
assert.match(html,/runtime\.js\?v=20260926-compact-production-3/);
...
assert.equal((source.match(/sb\.from\(/g)||[]).length,5,'pending reminders reuse the shared follow-up read');
