...
const points=C.detectCorners(image(30,true));assert(points);[{x:40,y:40},{x:200,y:40},{x:200,y:140},{x:40,y:140}].forEach((p,i)=>assert(Math.hypot(points[i].x-p.x,points[i].y-p.y)<4));
