...
assert.match(source,/function scheduleWhatsappRefresh\(delay=700,checkGoogle=false\)/,'WhatsApp/Google refreshes must be debounced');
...
assert.match(html,/contact-google-inline\.js\?v=20260912-verified-dropdown-1/,'the browser must load the on-demand contact synchronizer');
