...
const automations=fs.readFileSync('js/modules/contact-automation-status.js','utf8');
...
assert.match(summary,/group\(root,'automation','Automatizaciones',\[automation\]\)/,'Automatizaciones debe tener su propio desplegable.');
assert.match(summary,/group\(root,'offers','Ofertas y seguimiento',\[offers\]\)/,'Ofertas debe tener su propio desplegable.');
assert.match(automations,/cpAutomationStatus/,'La ficha debe restaurar el bloque de automatizaciones.');
