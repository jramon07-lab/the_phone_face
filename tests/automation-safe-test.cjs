...
assert.match(index,/automation-safe-test\.js\?v=20260910-safe-test-4/);
...
assert.match(moduleText,/id="astOfferOperator"/);
assert.match(moduleText,/Operador de la oferta/);
...
assert.match(moduleText,/function offerPreview/);
assert.match(moduleText,/trigger_type==='manual_offer'/);
assert.match(moduleText,/stage_name:'Seguimiento'/);
assert.match(moduleText,/record_offer_month/);
assert.match(moduleText,/offer_phase:'reminder_2'/);
assert.match(moduleText,/offer_phase:'reminder_5'/);
assert.match(moduleText,/condition_type:'no_response'/);
