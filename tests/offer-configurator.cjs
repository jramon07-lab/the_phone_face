...
const welcomeSenderSql=fs.readFileSync(path.join(root,'supabase/migrations/20260917100500_offer_welcome_sender.sql'),'utf8');
assert.match(welcomeSenderSql,/crm_create_offer_execution_v8/);
assert.match(welcomeSenderSql,/crm_create_offer_execution_v7/);
assert.match(source,/crm_create_offer_execution_v8/);
