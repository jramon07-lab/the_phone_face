...
assert.match(source,/id="opScheduledAt" type="datetime-local" step="1800"/,'date and time share one field with 30-minute steps');
assert.doesNotMatch(source,/id="opScheduleDate"|id="opScheduleTime"|name="opSendTiming"/,'separate date/time controls and large timing cards are removed');
