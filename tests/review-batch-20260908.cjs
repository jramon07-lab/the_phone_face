...
for(const value of ['Centro de control','acOverview','acOperatorFilter','acAutomationFilter','acErrorTypeFilter','Cliente','Ver incidencia →','Ver pasos →','Reintentar paso'])assert.match(errors,new RegExp(value));
