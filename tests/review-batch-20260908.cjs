...
for(const value of ['Centro de ejecuciones y errores','acOperatorFilter','acAutomationFilter','acErrorTypeFilter','Ver cliente','Ver ejecución','Reintentar paso'])assert.match(errors,new RegExp(value));
