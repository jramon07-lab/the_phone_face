...
Base recuperada: estable `734db09915a7dbf0b6cbc876264274768120838e`; desarrollo `576bcf0870fe921bdbfffe5a6e18546fa4c94091`. El enlace estable se conserva. Publicación actual: **dec705c**, comprobada antes y después; véase [informe de publicación](release-20260909.md).
...
|---|---|---|---|---|---|
| 01 | Sesión | Entrar, persistir sesión, salir, caducidad y recuperación | Sesión correcta; datos inaccesibles tras salir; errores visibles | Cierre global corregido a scope local: 100 regresiones y renovación real del segundo PC aprobada en Chrome 34330713702; publicado dec705c tras ensayo reforzado 34331867238 aprobado | CORREGIDO / PARCIAL |
...
| 07 | Relaciones | Titular, gestor, varios titulares, creación y cambio de vínculos | No mezcla personas, detecta duplicados y preserva relaciones | contact-relations, crm-complete-flows; un fallo de consulta en 34330713702 intento 1 no se repite en intento 2, causa pendiente; ensayo reforzado y publicación pasan | PARCIAL / INCIDENCIA ABIERTA |
...
| 31 | Documentos y Drive | Enlazar, crear carpeta, buscar, subir, listar, descargar y papelera | Archivo real sintético recuperable e idéntico; permisos y limpieza | 34327416743: carpeta, PDF, confirmación, listado y papelera aprobados; descarga independiente idéntica (618 bytes/SHA256) | COMPROBADO EN ENSAYO |
...
| 42 | Despliegue y continuidad | Commit, alias, caché, versión PC/móvil y recuperación de código | Enlace estable conserva versión comprobada y evidencia de ese commit | Estable dec705c READY; 100 internas y 50 Chrome antes y después, 3 omitidas; 34332948637 y 34332969490 | PARCIAL |
...
### Resultado confirmado de Drive y archivo compartido

Candidato 8a768a7: [Chrome 34327435911](https://github.com/jramon07-lab/the_phone_face/actions/runs/34327435911), 49 aprobadas y 3 omitidas; [integraciones reales 34327416743](https://github.com/jramon07-lab/the_phone_face/actions/runs/34327416743), 2 aprobadas. La corrección del origen de subida resuelve el fallo reproducido en Preview. Se descargó el PDF desde Drive por una vía independiente: 618 bytes e igualdad exacta de contenido y SHA256. Contacto y fila de archivo sintéticos retirados; artefactos de Drive conservados y registrados en continuidad. Esto no sustituye la restauración completa ni la prueba de todos los tipos/tamaños de archivos.

La revisión posterior del diagnóstico está guardada en 29f6b31, 99 regresiones locales aprobadas. Su Chrome 34328280876 sigue pendiente de consultar; el enlace estable conserva 734db099. El usuario mostró otro error de Work; el acceso de administrador ya está resuelto, pero su navegador necesita recuperación manual para continuar copia y exportación.
