...
function buildUi(){
 ...
 const app=document.createElement('div');app.id='tpfContactsApp';app.className='tpfContactsApp';app.innerHTML=`
  ...
  <div class="tpfContactsBody">
   <aside id="tpfContactsFilters" class="tpfContactsFilters"><div class="tpfContactsFiltersHead"><b>Filtros</b><button id="tpfContactsFiltersClose" class="secondary tpfContactsMobileClose" aria-label="Cerrar filtros">×</button></div><label>Nombre y apellidos<input id="tpfFilterName"></label><label>DNI<input id="tpfFilterDni"></label><label>Teléfono<input id="tpfFilterPhone"></label><label>Origen<select id="tpfFilterSource"><option value="">Todos</option></select></label><label>Etiquetas<select id="tpfFilterLabel"><option value="">Todas</option></select></label><section class="tpfOpportunityFilters"><b>Oportunidades</b><label>Estado<select id="tpfFilterOppStatus"><option value="">Todos</option><option value="open">Abiertas</option><option value="won">Ganadas</option><option value="lost">Perdidas</option></select></label><label>Cierre desde<input id="tpfFilterCloseFrom" type="date"></label><label>Cierre hasta<input id="tpfFilterCloseTo" type="date"></label></section><button id="tpfContactsClearFilters" class="secondary tpfClear">Limpiar filtros</button></aside>
