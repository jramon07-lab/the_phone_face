(function(){
  ...
  window.TPFModules=api;emit('runtime','ready');setTimeout(installWhatsappLogoutPlacement,0);setTimeout(loadContactProfile,0);setTimeout(loadWhatsappOpportunityPlus,0);
})();
