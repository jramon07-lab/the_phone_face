...
function ensureCss(){
 ...
 link.href='/assets/dashboard-home.css?v=20260919-home-reference-4';document.head.appendChild(link);
}

function build(){
  const v=$('view-dashboard');if(!v||D.built)return;
  D.backupJson=$('backupJson');D.backupCsv=$('backupCsv');
  v.classList.add('tpfDashPro');v.dataset.homeVersion='20260919-home-reference-4';
  v.innerHTML=`
  <header class="tdHero">
