...
M.register('contacts-list-layout',{install(){
  ...
  style.textContent=`
    ...
    #view-database.tpfContactsEnhanced .tpfContactsTableCard,
    #view-database.tpfContactsEnhanced .tpfContactsTableScroll{min-width:0!important;max-width:100%!important;box-sizing:border-box!important}
    #view-database.tpfContactsEnhanced .tpfContactsTableScroll{overflow-x:auto!important;overscroll-behavior-x:contain!important}
