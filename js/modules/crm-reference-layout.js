...
function opportunity(){
 ...
 function update(){
  ...
  const managerRow=summary.querySelector('[data-crm-summary="manager"]').parentElement;managerRow.hidden=samePerson;managerRow.previousElementSibling.hidden=samePerson;
  setText(summary.querySelector('[data-crm-summary="holder"]').parentElement.previousElementSibling,samePerson?'Titular y gestor':'Titular del contrato');
