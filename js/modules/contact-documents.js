...
function scanDocument(){
 ...
 window.TPFDocumentScanner.open({name:name(),folderName:folder.name,holderName:snapshot.TPF_TITULAR?.same===false?snapshot.TPF_TITULAR.holder_name:'',
 check,
