...
.tpfMonthlyCard{width:min(1560px,99vw);height:98vh;background:#f6f8fb;border:1px solid #ffffff2e;border-radius:18px;box-shadow:0 30px 90px #0008;display:flex;flex-direction:column;overflow:auto;overscroll-behavior:contain}
...
.tpfMonthlyBody{flex:0 0 auto;min-height:0;padding:10px;display:flex;flex-direction:column;gap:10px}
.tpfMonthlyMain{flex:0 0 auto;min-height:0;display:flex;flex-direction:column;gap:10px}
...
.tpfMonthlySection{flex:0 0 auto;min-height:0;display:flex;flex-direction:column;overflow:visible}
...
.tpfMonthlyTableWrap{flex:0 0 auto;min-height:0;overflow:visible}
