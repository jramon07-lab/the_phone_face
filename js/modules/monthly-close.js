...
.tpfMonthlyBody{flex:1;min-height:0;padding:10px;display:flex;flex-direction:column;gap:10px}
.tpfMonthlyMain{flex:1;min-height:0;display:flex;flex-direction:column;gap:10px}
...
@media(max-width:1000px){#tpfMonthlyClose{padding:8px}.tpfMonthlyCard{height:98vh;width:98vw;border-radius:18px}.tpfMonthlyBody{overflow:auto}.tpfMonthlySection{min-height:520px}.tpfMonthlyStats{grid-template-columns:1fr}.tpfMonthlyTabs{flex-wrap:wrap}.tpfMonthlyFoot{position:sticky;bottom:0;align-items:flex-start;flex-direction:column}.tpfMonthlyFootActions{width:100%;justify-content:flex-end}}
