Warning: truncated output (original token count: 61588)
...
(function(){
  ...
  async function saveProfileLabels(contactId){
    ...
    try{
      const current=await client.rpc('crm_get_contact_labels',{p_contact_id:contactId});if(current.error)thro…11588 tokens truncated…');
