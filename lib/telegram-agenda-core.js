...
function parseCallbackData(value){
  const match=/^tpf:task:(complete|postpone|date|menu|snooze|day):(?:(15m|30m|1h|2h|[1-7]):)?([0-9a-z-]{1,40})$/i.exec(clean(value));
...
module.exports={DEFAULT_DELIVERY_WINDOW_MS,deliveryKey,notificationMoments,dueDeliveries,deliverySignature,madridDateTime,recordDni,taskMessage,callbackData,parseCallbackData,callbackTaskId,normalizedPhone,callLink,initialKeyboard,postponeKeyboard,dateKeyboard,postponedAt,moveToMadridDay,webhookSecret};
